...
class Settings {
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Use the java book version with the launcher';
        ...
        document.querySelector(".path-button").addEventListener("click", async() => {
            ...
            } else alert("File name must be java or javaw");

        });

        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Use the Java book version with the launcher';
            file.value = '';
